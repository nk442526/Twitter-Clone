...
<html lang="en" class=""><head>
      ...
      <style class="INLINE_PEN_STYLESHEET_ID">
         ...
         --cs-surface-2: #eef4f8;
         --cs-separator: #e8ecf0;
         --cs-on-surface-primary: ##0000007d;
                       ...
                       <div class="joke">
                          <div class="joke_wrapper">
                             <div class="joke_block joke_block--header">
                                ...
                                <div class="joke_element joke_element--author-img"><img src="/static/images/dummyImage.jpg"></div>
                             </div>
                             <button class="follow-member" member-id="${member.id}" type="submit" tabindex="0" style="margin-top: 15px;margin-left: 80px;">
